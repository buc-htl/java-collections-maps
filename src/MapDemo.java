...
public class MapDemo {
    ...
    public static void main(String[] args) {
        ...
        // Map<String, String> map = new LinkedHashMap<>(); // merkt sich die
        // Reihenfolge, in der die Elemente in die Map gegeben werden
        // Map<String, String> map = new TreeMap<>(); // benützt das normale "compareTo"
        // Map<String, String> map = new TreeMap<>((a,b) -> b.compareToIgnoreCase(a));
        // // Reverse-Sortiert
